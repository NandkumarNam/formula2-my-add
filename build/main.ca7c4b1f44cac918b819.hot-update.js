...
function (_React$Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(RaceStanding, [{
    ...
    value: function mapDriversResults() {
      this.state.raceResults.map(function (racer) {
        var id = racer.id,
    ...
    value: function render() {
      ...
      }, error.message) : null, !isLoading ? "<ul className=\"f2-podium--raceStanding-list\">".concat(this.mapDriversResults(), "</ul>") : react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("h3", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 177
        }
...
//# sourceMappingURL=main.ca7c4b1f44cac918b819.hot-update.js.map