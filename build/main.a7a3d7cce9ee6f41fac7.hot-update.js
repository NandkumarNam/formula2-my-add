...
var App = function App(_ref) {
  ...
  return routes ? react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(NavLink, {
      style: {
        marginRight: '1rem',
        color: '#0af'
      },
    ...
    return (// pass in the initialData from the server or window.DATA for this
      // specific route
      react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Route, {
        key: uid(route),
        path: route.path,
        exact: route.exact,
...
//# sourceMappingURL=main.a7a3d7cce9ee6f41fac7.hot-update.js.map